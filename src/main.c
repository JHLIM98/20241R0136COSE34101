...
int main()
{
    ...
    result *SJF_result, *FCFS_result, *PRIORITY_result, *RR_result, *SJF_P_result, *PRIORITY_P_result, *MLQ_result, *MLFQ_result, *WRR_result;
    ...
    PRIORITY_P_result = init_result("PRIORITY_Preemp");
    ...
    while (1) {
        ...
        printf("1: FCFS 결과 및 간트 차트 출력\n");
        printf("2: SJF 결과 및 간트 차트 출력\n");
        printf("3: SJF_Preemptive 결과 및 간트 차트 출력\n");
        printf("4: PRIORITY 결과 및 간트 차트 출력\n");
        printf("5: PRIORITY_Preemptive 결과 및 간트 차트 출력\n");
        printf("6: RR 결과 및 간트 차트 출력\n");
        printf("7: MLQ 결과 및 간트 차트 출력\n");
        printf("8: MLFQ 결과 및 간트 차트 출력\n");
        printf("9: WRR 결과 및 간트 차트 출력\n");
